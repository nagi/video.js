  ...
  *         The evented object we are validating for
  ...
  var Player = /*#__PURE__*/function (_Component) {
    ...
    _proto.documentFullscreenChange_ = function documentFullscreenChange_(e) {
      ...
      var el = this.el(); // TODO: Use this.fullscreenElement_ which defaults to this.el_ when option not set

      var isFs = document[this.fsApi_.fullscreenElement] === el || document[this.fsApi_.fullscreenElement] === this.options_.fullscreenElement;
    ...
    _proto.requestFullscreenHelper_ = function requestFullscreenHelper_(fullscreenOptions) {
      ...
      if (this.fsApi_.requestFullscreen) {
        var promise = (this.options_.fullscreenElement || this.el_)[this.fsApi_.requestFullscreen](fsOptions);
